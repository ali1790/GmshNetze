...
Point(4) = {3.000000, 1.000000, 0.0, 0.100000};
Line(1) = {1, 2};
Line(2) = {1, 3};
Line(3) = {2, 4};
Line(4) = {3, 4};
...
Point(6) = {3.000000, 1.010000, 0.0, 0.100000};
Line(5) = {3, 5};
Line(6) = {4, 6};
Line(7) = {5, 6};
Line Loop(2) = {4,6,-7,-5};
...
Point(8) = {3.000000, 1.990000, 0.0, 0.100000};
Line(8) = {5, 7};
Line(9) = {6, 8};
Line(10) = {7, 8};
...
Point(10) = {3.000000, 2.000000, 0.0, 0.100000};
Line(11) = {7, 9};
Line(12) = {8, 10};
Line(13) = {9, 10};
...
Plane Surface(5) = {5};
Physical Surface(1) = {1};Physical Surface(2) = {2};Physical Surface(3) = {3};Physical Surface(4) = {4};Physical Surface(5) = {5};Mesh 1;
Mesh 2;
Save "mylaminate.m";
Mesh 1;
Mesh 2;
